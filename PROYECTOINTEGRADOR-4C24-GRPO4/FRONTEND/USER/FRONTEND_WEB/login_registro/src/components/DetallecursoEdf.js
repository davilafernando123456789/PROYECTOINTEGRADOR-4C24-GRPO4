...
const DetallecursoEdf = () => {
  const curso = {
    idCurso: 1,
    nombre: 'Educación Fisica',
    codigo: 'EDF201',
    imagenAlumno: 'https://colegiomariaraquel.cl/web/wp-content/uploads/2022/11/icono-1-1140x1074.jpg', // Agrega la URL de la foto del alumno
 ...
 <div className="row mt-4 justify-content-center">
      ...
      <div className="card-body">
        ...
        <div className="card border-primary">
          ...
          <div className="col-md-4">
            <div className="card border-primary">
              <div className="card-body">
              <Link to="/NotificacionesE" className="link-black">
                <img
  ...
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/TemarioE" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/ComentariosE" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/NotasE" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
...
export default DetallecursoEdf;
