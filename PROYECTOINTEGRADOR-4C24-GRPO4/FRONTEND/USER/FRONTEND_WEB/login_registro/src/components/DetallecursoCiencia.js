...
const DetallecursoCiencia = () => {
  const curso = {
    idCurso: 1,
    nombre: 'Ciencias',
    codigo: 'CIE301',
    imagenAlumno: 'https://cdn-icons-png.flaticon.com/512/1046/1046269.png?w=360', // Agrega la URL de la foto del alumno
 ...
 <div className="row mt-4 justify-content-center">
      ...
      <div className="card-body">
        ...
        <div className="card border-primary">
          ...
          <div className="col-md-4">
            <div className="card border-primary">
              <div className="card-body">
              <Link to="/NotificacionesC" className="link-black">
                <img
  ...
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/TemarioC" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/ComentariosC" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/NotasC" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
...
export default DetallecursoCiencia;
