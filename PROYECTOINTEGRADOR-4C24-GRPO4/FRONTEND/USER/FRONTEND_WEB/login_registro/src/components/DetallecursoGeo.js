...
const DetallecursoGeo = () => {
  const curso = {
    idCurso: 1,
    nombre: 'Geografía',
    codigo: 'GEO301',
    imagenAlumno: 'https://cdn-icons-png.flaticon.com/512/3269/3269712.png', // Agrega la URL de la foto del alumno
  };
 ...
 <div className="row mt-4 justify-content-center">
      ...
      <div className="card-body">
        ...
        <div className="card border-primary">
          ...
          <div className="col-md-4">
            <div className="card border-primary">
              <div className="card-body">
              <Link to="/NotificacionesG" className="link-black">
                <img
  ...
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/TemarioG" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/ComentariosG" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/NotasG" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
...
export default DetallecursoGeo;
