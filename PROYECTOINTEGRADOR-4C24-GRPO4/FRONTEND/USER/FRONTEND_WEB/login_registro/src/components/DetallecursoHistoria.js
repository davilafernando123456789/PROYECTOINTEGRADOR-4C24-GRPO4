...
const DetallesCursoHistoria = () => {
  const curso = {
    idCurso: 1,
    nombre: 'Historia',
    codigo: 'HIS101',
    imagenAlumno: 'https://cdn-icons-png.flaticon.com/512/2234/2234770.png', // Agrega la URL de la foto del alumno
   ...
   <div className="row mt-4 justify-content-center">
        ...
        <div className="card-body">
          ...
          <div className="card border-primary">
            ...
            <div className="col-md-4">
              <div className="card border-primary">
                <div className="card-body">
                <Link to="/NotificacionesH" className="link-black">
                  <img
    ...
    <div className="card">
      <div className="card-body text-center">
        ...
        <Link to="/TemarioH" className="btn btn-primary btn-block">Abrir</Link>
      </div>
    </div>
  </div>
  <div className="col-md-3">
    <div className="card">
      <div className="card-body text-center">
        ...
        <Link to="/ComentariosH" className="btn btn-primary btn-block">Abrir</Link>
      </div>
    </div>
  </div>
  <div className="col-md-3">
    <div className="card">
      <div className="card-body text-center">
        ...
        <Link to="/NotasH" className="btn btn-primary btn-block">Abrir</Link>
      </div>
    </div>
  </div>
  <div className="col-md-3">
...
export default DetallesCursoHistoria;
