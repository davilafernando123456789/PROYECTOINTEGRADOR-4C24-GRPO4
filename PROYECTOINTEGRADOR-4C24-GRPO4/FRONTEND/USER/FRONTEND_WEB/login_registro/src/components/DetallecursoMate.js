 ...
 <div className="row mt-4 justify-content-center">
      ...
      <div className="card-body">
        ...
        <div className="card border-primary">
          ...
          <div className="col-md-4">
            <div className="card border-primary">
              <div className="card-body">
              <Link to="/NotificacionesM" className="link-black">
                <img
  ...
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/TemarioM" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/ComentariosM" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
  <div className="card">
    <div className="card-body text-center">
      ...
      <Link to="/NotasM" className="btn btn-primary btn-block">Abrir</Link>
    </div>
  </div>
</div>
<div className="col-md-3">
